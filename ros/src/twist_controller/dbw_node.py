...
class DBWNode(object):
    def __init__(self):
        ...
        self.dbw_controller = Controller(vehicle_mass, wheel_base, wheel_radius, steer_ratio, min_speed, max_lat_accel, max_steer_angle, accel_limit, decel_limit, self.process_rate)
